# -*- coding: utf-8 -*-
"""
Created on Mon Jan 28 16:10:18 2019
...
test_data   = pd.read_csv(r'C:\Users\ZHOU-JC\Desktop\data match\PUBG Finish Placement Prediction(Kernels Only)\test_V2.csv',nrows=10000)
# 删掉缺失值
...
all_data['headshotrate'] = all_data['kills']/all_data['headshotKills']
...
all_data['distance_over_weapons'] = all_data['Total_distance'] / all_data['weaponsAcquired']
all_data['walkDistance_over_heals'] = all_data['walkDistance'] / all_data['heals']
all_data['walkDistance_over_kills'] = all_data['walkDistance'] / all_data['kills']
all_data['killsPerWalkDistance'] = all_data['kills'] / all_data['walkDistance']
...
for c in exclude_agg_col:
    agg_col.remove(c)
#%% 
sum_col = ['walkDistance', 'Total_distance', 'boosts','weaponsAcquired','healthItems',
           'engage','damageDealt','heals','kills','longestKill']
...
#
X_train.to_csv(r'C:\Users\ZHOU-JC\Desktop\data match\PUBG Finish Placement Prediction(Kernels Only)\X_train.csv')
X_test.to_csv(r'C:\Users\ZHOU-JC\Desktop\data match\PUBG Finish Placement Prediction(Kernels Only)\X_test.csv')
Y_train.to_csv(r'C:\Users\ZHOU-JC\Desktop\data match\PUBG Finish Placement Prediction(Kernels Only)\Y_train.csv')
X_test_Id.to_csv(r'C:\Users\ZHOU-JC\Desktop\data match\PUBG Finish Placement Prediction(Kernels Only)\X_test_Id.csv')
...
result.to_csv(r'C:\Users\ZHOU-JC\Desktop\data match\PUBG Finish Placement Prediction(Kernels Only)\result.csv', index=False)
...
result[["Id", "winPlacePerc"]].to_csv("submission2.csv", index=False)
